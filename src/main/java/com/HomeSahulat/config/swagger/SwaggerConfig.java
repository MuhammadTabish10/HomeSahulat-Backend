package com.HomeSahulat.config.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.HomeSahulat"))
                .paths(PathSelectors.any())
                .build().apiInfo(apiInfoMetaData());
    }

    private ApiInfo apiInfoMetaData() {
        return new ApiInfoBuilder().title("HomeSahulat")
                .description("HomeSahulat Api Documentation")
                .contact(new Contact("Tabish", "https://www.stepwaysoftwares.com", "muhammadtabish05@gmail.com"))
